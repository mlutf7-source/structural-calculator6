...
const Num = ({ id, go, label, value, set, unit }: any) => (
  <div style={{ background: "#fdfdfd", border: "1px solid #ddd", borderRadius: "8px", padding: "8px 5px", textAlign: "center" }}>
    ...
    <input id={id} type="text" inputMode="decimal" autoComplete="off" enterKeyHint={go ? "next" : "done"} style={{ width: "100%", border: "none", textAlign: "center", fontSize: "0.85rem", padding: "2px 0", outline: "none", background: "transparent", fontWeight: 700, fontFamily: "Cairo, sans-serif" }} value={value} onChange={(e) => set(e.target.value)} onFocus={(e) => e.target.select()} onKeyDown={(e) => { if (e.key === "Enter") { e.preventDefault(); goNext(go); } }} />
...
}, [netOuterWall, netInnerWall, floorArea, totalBathrooms, totalKitchens, totalDoors, totalWindows]);const calculate = () => {};
const reset = () => {
...
<div className="model-card" style={{ border: "1px solid #ddd", borderRadius: "12px", overflow: "hidden", background: "white", marginTop: "12px" }}>
  ...
  <div className="model-body" style={{ padding: "10px 12px" }}>
    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.7rem" }}>
      ...
      <tbody>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>مساحة البناء</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(netOuterWall / FL)} م²</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(netOuterWall)} م²</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>عدد البلك</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil(netOuterWall / FL / 0.08)}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil(netOuterWall / 0.08)}</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>أكياس الأسمنت</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil((Math.ceil(netOuterWall / FL / 0.08) / 1000) * 20)}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil((Math.ceil(netOuterWall / 0.08) / 1000) * 20)}</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>الرمل</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(Math.ceil((Math.ceil(netOuterWall / FL / 0.08) / 1000) * 20) * 0.1)} م³</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(Math.ceil((Math.ceil(netOuterWall / 0.08) / 1000) * 20) * 0.1)} م³</td></tr>
      </tbody>
    </table>
  </div>
</div>
...
<div className="model-card" style={{ border: "1px solid #ddd", borderRadius: "12px", overflow: "hidden", background: "white" }}>
  ...
  <div className="model-body" style={{ padding: "10px 12px" }}>
    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.7rem" }}>
      <thead><tr style={{ background: "#003366", color: "white" }}><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>البند</th><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>لدور واحد</th><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>الكلي ({FL} أدوار)</th></tr></thead>
      <tbody>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>مساحة البناء</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(netInnerWall / FL)} م²</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(netInnerWall)} م²</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>عدد البلك</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil(netInnerWall / FL / 0.08)}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil(netInnerWall / 0.08)}</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>أكياس الأسمنت</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil((Math.ceil(netInnerWall / FL / 0.08) / 1000) * 20)}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{Math.ceil((Math.ceil(netInnerWall / 0.08) / 1000) * 20)}</td></tr>
        <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>الرمل</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(Math.ceil((Math.ceil(netInnerWall / FL / 0.08) / 1000) * 20) * 0.1)} م³</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{fmtNum(Math.ceil((Math.ceil(netInnerWall / 0.08) / 1000) * 20) * 0.1)} م³</td></tr>
      </tbody>
    </table>
  </div>
      ...
      <div className="model-card" style={{ border: "1px solid #ddd", borderRadius: "12px", overflow: "hidden", background: "white" }}>
        ...
        <div className="model-body" style={{ padding: "10px 12px" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.7rem" }}>
            <thead><tr style={{ background: "#003366", color: "white" }}><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>البند</th><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>لدور واحد</th><th style={{ padding: "8px 5px", border: "1px solid #003366" }}>الكلي ({FL} أدوار)</th></tr></thead>
            <tbody>
              <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>الحمامات</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{BA}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{totalBathrooms}</td></tr>
              <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>المطابخ</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{KI}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{totalKitchens}</td></tr>
              <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>الأبواب</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{DR}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{totalDoors}</td></tr>
              <tr><td style={{ padding: "6px 5px", border: "1px solid #ccc", fontWeight: 700 }}>النوافذ</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{WN}</td><td style={{ padding: "6px 5px", border: "1px solid #ccc", textAlign: "center" }}>{totalWindows}</td></tr>
            </tbody>
          </table>
        </div>
      </div>
